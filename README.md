...
| `docs/` | Design docs, [configuration sources](docs/configuration-sources.md), [mistakes log](docs/mistakes-log.md), [access guide](docs/access-guide.md), implementation plans |
