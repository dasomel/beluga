...
log_success " Access URLs (via *.local.beluga.internal):"
...
log_success " - Trino UI:       http://trino.local.beluga.internal:8080"
log_success " - Airflow UI:     http://airflow.local.beluga.internal:8085"
log_success " - Superset UI:    http://superset.local.beluga.internal:8088"
log_success " - Lakekeeper:     http://catalog.local.beluga.internal:8181"
log_success " - SeaweedFS S3:   http://s3.local.beluga.internal:8333"
log_success " - ArgoCD UI:      https://argocd.local.beluga.internal:8443"
log_success "=========================================================="
