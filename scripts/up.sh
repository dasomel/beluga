...
log_success " Access URLs (via *.beluga.local):"
log_success " (Add to /etc/hosts: '127.0.0.1 trino.beluga.local airflow.beluga.local superset.beluga.local catalog.beluga.local s3.beluga.local argocd.beluga.local')"
log_success " - Trino UI:       http://trino.beluga.local:8080"
log_success " - Airflow UI:     http://airflow.beluga.local:8085"
log_success " - Superset UI:    http://superset.beluga.local:8088"
log_success " - Lakekeeper:     http://catalog.beluga.local:8181"
log_success " - SeaweedFS S3:   http://s3.beluga.local:8333"
log_success " - ArgoCD UI:      https://argocd.beluga.local:8443"
log_success "=========================================================="
